        ...
        <div className="cards w-full flex gap-10 mt-10">
                <motion.div
                 ...
                 className="card-container relative  w-1/2 h-[75vh]">
                  <h1 className=' flex overflow-hidden absolute text-[#CDEA68] z-[9] leading-none right-0 translate-x-1/2 top-1/2 -translate-y-1/2 tracking-tighter text-8xl'>
                ...
                className="card-container relative w-1/2 h-[75vh]">  
                    <div className="card w-full h-full  rounded-xl overflow-hidden">
                    <h1 className='absolute overflow-hidden flex text-[#CDEA68] z-[9] leading-none right-full translate-x-1/2 top-1/2 -translate-y-1/2 tracking-tighter text-8xl'>
