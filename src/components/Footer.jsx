  ...
  return (
    <div className='w-full h-screen bg-zinc-900 p-20 flex gap-5'>
        <div className="w-1/2 h-full flex flex-col justify-between">
            ...
            <h1 className='text-[6vw] tracking-tighter font-semibold uppercase leading-none -mb-5'>Eye-</h1>
            <h1 className='text-[6vw] tracking-tighter font-semibold uppercase leading-none -mb-5'>Opening</h1>
            </div>
        ...
        <div className="w-1/2">
        <h1 className='text-[6vw] font-semibold uppercase leading-none tracking-tighter -mb-5'>Presentations</h1>
        <div className="dets font-['Neue_Montreal'] mt-10">
        <a className='underline block text-md font-light' href="#">Instagram</a>
        <a className='underline block text-md font-light' href="#">Behance</a>
        <a className='underline block text-md font-light' href="#">Facebook</a>
        <a className='underline block text-md font-light' href="#">LinkedIn</a>
        </div>
        </div>
    </div>
  )
